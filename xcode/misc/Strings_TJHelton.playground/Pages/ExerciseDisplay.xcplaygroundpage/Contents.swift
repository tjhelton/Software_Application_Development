...
let used = 3000
let minOfVideo = 150
let remainingStorage = iphone - used

let storageLeft = "your phone has \(remainingStorage) mb remaining"

let minutesToRecord = "you can record up to \(remainingStorage / minOfVideo) more minutes of video"
