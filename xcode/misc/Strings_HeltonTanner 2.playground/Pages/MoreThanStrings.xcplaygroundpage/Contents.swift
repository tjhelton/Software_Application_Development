...
let number = 99
let brShirt = "brownshirt"
let place = "mall"
let pEmot = "happy"
let nEmot = "sad"
let food = "ice cream"
let story = "Today was a big day for \(goalieName). They had finally saved up \(number) dollars and were going to buy a \(brShirt). They went to the \(place) feeling very \(pEmot). But then they felt \(nEmot). They were all out of \(food)!"
