...
let mornings = brushTeeth + chooseClothes + shower + finishHomework + drive + socialMedia
...
let need = brushTeeth + chooseClothes + shower + drive
let like = finishHomework + socialMedia
...
*/
//my ideal morning routine is pretty much the one that I already carry out. 
