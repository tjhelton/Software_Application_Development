...
let interpolation = "String interpolation using \\(value)"
let escaping = "Using \\ for special powers"
let newline = "\\n makes a newline"
/*:
 ...
 */
let whatWeKnow = "We learned abount \(constants), \(unicode), \(combining), \(interpolation), \(escaping), and \(newline)"




//:
//:[Previous](@previous)  |  page 13 of 16  |  [Next: Scene: A restaurant](@next)
