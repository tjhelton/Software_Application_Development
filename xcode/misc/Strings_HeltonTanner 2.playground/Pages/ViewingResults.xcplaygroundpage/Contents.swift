...
//: In the results sidebar, move the cursor to point at the line that begins as “Why, sometimes I’ve believed”. When you do, that result will become highlighted and two controls will appear:
