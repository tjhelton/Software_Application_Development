...
/*:
 ...
 Three other guests enter, and place their orders as well:
 */
...
/*:
 The server speaks all of these languages and is unfazed, confidently repeating the orders back to the group.
...
//:
//:[Previous](@previous)  |  page 14 of 16  |  [Next: Go Fight Win!](@next)
