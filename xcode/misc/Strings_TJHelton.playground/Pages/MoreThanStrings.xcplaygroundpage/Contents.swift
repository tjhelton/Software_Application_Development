...
let secondHalf = 2
let overtime = 4
let goalieReport = "at the game tonight, \(goalie) had \(firstHalf) saves in the first half, \(secondHalf) saves in the second half, and \(overtime) saves in overtime for a total of \(firstHalf + secondHalf + overtime) saves"
